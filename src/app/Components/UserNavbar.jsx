...
export default function UserNavbar() {
  ...
  const navItems = [
    ...
    ...(session?.user?.role === 'EDUCATOR'
      ? [
        { href: '/educator', icon: 'bi-mortarboard', label: 'Educator' },
        { href: '/educator/exam-create', icon: 'bi-file-earmark-plus', label: 'Create Exam' },
        { href: '/educator/exam-manage', icon: 'bi-clipboard-check', label: 'Manage Exams' },
      ]
      : session?.user?.role === 'STUDENT'
        ? [
          { href: '/student', icon: 'bi-person', label: 'Student' },
          { href: '/student/exam', icon: 'bi-journal-text', label: 'My Exams' },
          //{ href: '/student/take-exam', icon: 'bi-pencil-square', label: 'Take Exam' },
        ]
        : [])
  ];
